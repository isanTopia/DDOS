...
def helptext ():
        print ""
        print " 00""'Yb   D00000         DD000     "
        print " 000000dP  D0000000        00000    "
        print " 000000dP  D00000000      00  000   "
        print " 00 _ dP   D00000000     00    0000 "
        print " 00        D00000000    00          "
        print " 00        D000000     00           "
        print " 00        D0000      00            "
        print ""
        print "Usage: %s is 1.1 for GNU/Linux - Dos or DDos Tools <hostname> [-t] [-c] [-p]\n" % sys.argv[0]
        print " EX. python2 Private.py (IP Server) -t (Number Of Threads) -c (Number Connections/threads) -p (Port)"
        print ""
        ...
        print ""
        print " DDos Code By KingOfnoobS"
        print ""
        print " Credit GalvinID"
        print ""
        print " Tools Modifed By KingOfnoobS"
        print " Tools Recode By KingOfnoobS"
        print ""
        print " User This Tools : KingOfnoobS"
        print ""
        print "Contact for any BUGS or GLITCHES on Discord KingOfnoobS#1192. Dont Share This Tools"
        exit()
